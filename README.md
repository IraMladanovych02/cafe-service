...
https://cafe-restaurant-service.onrender.com
...
2. Clone the forked repo git clone https://github.com/your-username/cafe-kitchen-service.git
...
4. Create superuser to manage the project: `python manage.py createsuperuser`
5. Run server to check the website
6. Run pytest to check if your solution is correct (from command line, or using PyCharm pytest support)
